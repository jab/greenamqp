...
import greenamqp.client_0_8 as amqp
from greenamqp.client_0_8.connection import AMQP_PROTOCOL_HEADER, _MethodReader
from greenamqp.client_0_8.serialization import AMQPReader, AMQPWriter
